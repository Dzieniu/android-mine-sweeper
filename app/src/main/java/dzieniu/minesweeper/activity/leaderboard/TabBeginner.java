...
public class TabBeginner extends Fragment {

    private static final String TAB_DIFFICULTY = "beginner";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_beginner, container, false);
        linearLayout = view.findViewById(R.id.beginnerList);
        scrollView = view.findViewById(R.id.beginnerScrollView);
