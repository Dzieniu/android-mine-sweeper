...
public class TabExpert extends Fragment {

    private static final String TAB_DIFFICULTY = "expert";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_expert, container, false);
        linearLayout = view.findViewById(R.id.expertList);
        scrollView = view.findViewById(R.id.expertScrollView);
